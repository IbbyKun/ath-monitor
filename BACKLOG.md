...
| 5.1b | Two productive-time targets still exist | 🟢 | 1 h | The shift's **Required Productive Time** now drives attendance, but the org-level **Monitoring Control → productive hours** still drives the dashboard gauge, and they do not read each other. Not broken; they can just disagree. Fold one into the other, or make Monitoring Control the default a new shift inherits. |
