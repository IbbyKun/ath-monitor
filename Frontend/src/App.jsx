...
import PendingSignups          from './page/protected/admin/pending-signups'
import AccountSettings         from './page/protected/admin/account-settings'
import OrgChartPage            from './page/protected/admin/org-chart'
...
// Disabled — GPS field tracking not in use for now.
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/admin/pending-signups"             element={<AdminProtectedRoute><PendingSignups /></AdminProtectedRoute>} />
        <Route path="/admin/account-settings"            element={<AdminProtectedRoute><AccountSettings /></AdminProtectedRoute>} />
        <Route path="/admin/org-chart"                   element={<AdminProtectedRoute><OrgChartPage /></AdminProtectedRoute>} />
