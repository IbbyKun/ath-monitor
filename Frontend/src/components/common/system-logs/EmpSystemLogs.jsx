...
const EmpSystemLogs = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-9 w-full">
      ...
      {/* Filters — #96 — see EmpEmailActivityLog for the same fix.
           min-w-0 on each item + relax lg packing density so the date picker
           and long CustomSelect labels don't visually overlap neighbors. */}
