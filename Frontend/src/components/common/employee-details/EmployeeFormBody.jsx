    ...
    <div className="px-8 pt-6 pb-2 space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-5">
        <Field label={t("emp_first_name")} required error={errors.firstName}>
          <Input placeholder={t("emp_enter_first_name")} value={form.firstName}
        ...
        <Field label={t("emp_last_name")} required error={errors.lastName}>
          <Input placeholder={t("emp_enter_last_name")} value={form.lastName}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-5">
        ...
        <Field label={t("emp_mobile_number")} error={errors.mobile || errors.countryCode}>
          <div className="flex items-center gap-2">
            ...
            <Input type="tel" placeholder={t("emp_phone_number")} value={form.mobile}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-5">
        <Field label={t("emp_employee_code")} required error={errors.employeeCode}>
          <Input placeholder={t("emp_employee_code")} value={form.employeeCode}
            onChange={(e) => set("employeeCode", e.target.value)}
            className="h-11 rounded-xl border-gray-300 text-[13px] px-5" />
        </Field>
        <Field label={t("location")} required error={errors.locationId}>
          <Select value={form.locationId} onValueChange={(v) => { set("locationId", v); set("departmentId", ""); }}>
            <SelectTrigger className="h-11 rounded-xl w-full border-gray-300 text-[13px] px-5">
              <SelectValue placeholder={t("emp_select_location")} />
            </SelectTrigger>
      ...
      {/* Role / Department */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-5">
        <Field label={t("emp_role")} required error={errors.roleId}>
          <Select value={form.roleId} onValueChange={(v) => set("roleId", v)}>
            <SelectTrigger className="h-11 rounded-xl w-full border-gray-300 text-[13px] px-5">
              <SelectValue placeholder={t("emp_select_role")} />
            </SelectTrigger>
            <SelectContent className="rounded-xl">
        ...
        <Field label={t("department")} required error={errors.departmentId}>
          <Select value={form.departmentId} onValueChange={(v) => set("departmentId", v)}
            ...
            <SelectTrigger className="h-11 rounded-xl w-full border-gray-300 text-[13px] px-5">
              <SelectValue placeholder={deptLoading ? t("emp_loading") : t("emp_select_department")} />
            </SelectTrigger>
            <SelectContent className="rounded-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-5">
        <Field label={t("emp_timezone")} required error={errors.timezone}>
          <Select value={form.timezone} onValueChange={(v) => set("timezone", v)}>
            <SelectTrigger className="h-11 rounded-xl w-full border-gray-300 text-[13px] px-5">
              <SelectValue placeholder={t("emp_select_timezone")} />
            </SelectTrigger>
        ...
        <Field label={t("emp_date_of_joining")}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-5">
        ...
        <Field label={t("emp_select_shift")}>
      ...
      {/* Address */}
      <div className="space-y-1.5">
        <textarea placeholder={t("emp_address")} value={form.address}
